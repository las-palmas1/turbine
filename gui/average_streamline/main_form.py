...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_3.addWidget(self.c_p_gas_av, 9, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.eta_l, 8, 1, 1, 1)
        ...
        self.N.setObjectName("N")
        self.gridLayout_3.addWidget(self.N, 11, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.k_gas_av, 10, 1, 1, 1)
        ...
        self.eta_t_stag_p = QtWidgets.QDoubleSpinBox(self.frame_2)
        self.eta_t_stag_p.setReadOnly(True)
        self.eta_t_stag_p.setDecimals(3)
        self.eta_t_stag_p.setObjectName("eta_t_stag_p")
        self.gridLayout_3.addWidget(self.eta_t_stag_p, 7, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(_translate("Form", "Политропический КПД по параметрам торможения"))
