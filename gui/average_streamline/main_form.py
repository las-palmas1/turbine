...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.T_t_cycle = QtWidgets.QDoubleSpinBox(self.frame)
        self.T_t_cycle.setMinimum(240.0)
        self.T_t_cycle.setMaximum(2500.0)
        self.T_t_cycle.setProperty("value", 800.0)
        self.T_t_cycle.setObjectName("T_t_cycle")
        self.gridLayout_2.addWidget(self.T_t_cycle, 13, 1, 1, 1)
        ...
        self.p_t_cycle = QtWidgets.QDoubleSpinBox(self.frame)
        self.p_t_cycle.setDecimals(4)
        self.p_t_cycle.setMinimum(0.06)
        self.p_t_cycle.setMaximum(5.0)
        self.p_t_cycle.setSingleStep(0.1)
        self.p_t_cycle.setProperty("value", 0.1)
        self.p_t_cycle.setObjectName("p_t_cycle")
        self.gridLayout_2.addWidget(self.p_t_cycle, 14, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(_translate("Form", "Статическое давление после турбины, МПа"))
        ...
        self.label_10.setText(_translate("Form", "Статическая температура после турбины, К"))
        ...
        self.label.setText(_translate("Form", "Удельнаяф работа турбины, кДж/кг"))
