...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.doubleSpinBox_20 = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.doubleSpinBox_20.setReadOnly(True)
        self.doubleSpinBox_20.setMaximum(10000.0)
        self.doubleSpinBox_20.setObjectName("doubleSpinBox_20")
        self.gridLayout_5.addWidget(self.doubleSpinBox_20, 5, 1, 1, 1)
        ...
        self.l0 = QtWidgets.QLabel(self.frame_6)
        self.l0.setObjectName("l0")
        self.gridLayout_5.addWidget(self.l0, 5, 0, 1, 1)
        ...
        self.eta_l_2 = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.eta_l_2.setReadOnly(True)
        self.eta_l_2.setMaximum(10000.0)
        self.eta_l_2.setObjectName("eta_l_2")
        self.gridLayout_6.addWidget(self.eta_l_2, 1, 7, 1, 1)
        self.eta_t_stage = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.eta_t_stage.setReadOnly(True)
        self.eta_t_stage.setMaximum(10000.0)
        self.eta_t_stage.setObjectName("eta_t_stage")
        self.gridLayout_6.addWidget(self.eta_t_stage, 2, 7, 1, 1)
        self.eta_t_stage_stag = QtWidgets.QDoubleSpinBox(self.frame_6)
        self.eta_t_stage_stag.setReadOnly(True)
        self.eta_t_stage_stag.setMaximum(10000.0)
        self.eta_t_stage_stag.setObjectName("eta_t_stage_stag")
        self.gridLayout_6.addWidget(self.eta_t_stage_stag, 3, 7, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.l0.setText(_translate("Form", "l0, м"))
